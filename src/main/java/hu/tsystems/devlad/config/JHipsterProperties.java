package hu.tsystems.devlad.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "devlad@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "devlad API";

        private String description = "devlad API documentation";
